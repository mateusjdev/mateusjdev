...
Entusiasta da computação e em constante aprendizado com foco na resolução de problemas, independentemente da linguagem ou tecnologia utilizada.

## 🏗️ Projetos

- [Scruffy](https://github.com/mateusjdev/scruffy) (Go): Um programa de utilidade geral para arquivos.
...
- [network-check](https://github.com/mateusjdev/network-check) (Go)
...
- 🔒 [huffman](https://github.com/mateusjdev/huffman) (Go)
- 🔒 [udf-lba](https://git.mateusj.dev/mateusjdev/udf-lba) (Python)
- 🔒 [ai-code](https://git.mateusj.dev/mateusjdev/ai-code)

<!--

## Linguagens

Já utilizei diversas linguagens durante o meu aprendizado. Nas linguagens de programação, sou proveniente em C# pelo costume durante a graduação, python pela facilidade e Go pela abordagem direta e moderna, mas tenho facilidade de me adaptar a qualquer outra linguagem.
